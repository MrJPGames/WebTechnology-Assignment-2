...
class ImageText extends General {
    ...
    createImage(imagePath, alternative) {
        ...
        this.image = new Image(imagePath, alternative);
    }
}

//Define the image clas
class Image {
    constructor(imagePath, alternative) {
...
class Article {
    ...
    constructor() {
        ...
        this.h1.appendChild(document.createTextNode("Summary"));
        window.articleTag.appendChild(this.h1);
        this.h1.setAttribute("id", "articleTitle")
...
class PageControl {
    ...
    addObjectToPage(obj) {
        ...
        if(obj instanceof ListText) 
            ...
            obj.image.img.id = "economicsImage";
        }
    }
}
